...
export default function Home() {
  ...
  const data = useStableLoaderData(loaderData as any, {
  ...
  const author = () =>
    users()[featured().authorId] || {
      name: "Guest Author",
      avatarUrl: "https://i.pravatar.cc/400?img=12",
    };
  const firstPopular = () => popular()[0] ?? fallbackTrending;
  const featuredAvatarTag = () => getPostAuthorAvatarTag(featuredAuthorId());
  const featuredStoryTransitionState = () =>
    createPostAuthorSharedTransitionState(featuredAuthorId());
        ...
        <stacklayout class="px-5 pt-4 pb-20" iosOverflowSafeAreaEnabled={false}>
          <gridlayout columns="*, auto" rows="auto" class="mb-4">
            <stacklayout col="0">
              ...
              />
              <label
                text="Native SolidJS News"
                class="text-[#d35121] dark:text-[#f2f6ff] text-2xl font-extrabold mt-1"
              />
            </stacklayout>
          ...
          <Link
            to={`/posts/$postId`}
            params={{ postId: featured().id }}
            state={featuredStoryTransitionState()}
          >
            <gridlayout
              rows="220, auto"
              class="rounded-[24] bg-white dark:bg-[#0e1628]"
            ...
            >
              ...
              >
                <label
                  text={featured().title}
                  class="text-white text-2xl font-bold leading-[3]"
                  textWrap={true}
                />
                <gridlayout
                  columns="auto, *, auto"
                ...
                >
                  ...
                  <label
                    col="2"
                    text={featured().readSecondsAgo}
                    class="text-white/75 text-xs"
                  />
                </gridlayout>
              </stacklayout>
            </gridlayout>
          ...
          <gridlayout
            columns="*, auto"
            rows="auto"
            class="mt-2 bg-white dark:bg-[#0f182d] rounded-[22] p-4"
          >
            <stacklayout col="0">
              <label
                text="/posts/2"
              ...
              />
              <label
                text="Route params + loader detail page"
            ...
            <stacklayout col="1">
              <Link to="/posts/$postId" params={{ postId: "2" }}>
                <label
                  text="Open"
                  class="bg-[#e8eefc] dark:bg-[#223156] text-[#3458c8] dark:text-[#9db5ff] rounded-full px-4 py-2 text-[14px]"
                />
              </Link>
            </stacklayout>
          </gridlayout>
          ...
          >
            <stacklayout col="0">
              ...
              />
              <label
                text="Search-driven modal route"
                class="text-[#8790a2] dark:text-[#9aa7c7] text-[13px] mt-1 leading-[3]"
                textWrap={true}
              />
            </stacklayout>
            <stacklayout col="1">
              <Link to="/posts" search={{ ["@modal"]: "/users/3" }}>
                <label
                  text="Try"
                  class="bg-[#fdebe4] dark:bg-[#4a2a1e] text-[#dd6236] dark:text-[#ff9b75] rounded-full px-4 py-2 text-[14px]"
                />
              </Link>
            </stacklayout>
          </gridlayout>
          ...
          <stacklayout class="bg-white dark:bg-[#0f182d] rounded-[22] mt-3 p-4">
            <label
              text={firstPopular().title}
              class="text-lg font-bold text-[#101522] dark:text-[#f2f6ff] leading-[3]"
              textWrap={true}
            />
            <gridlayout columns="auto, *" rows="auto" class="mt-2">
              <imagecacheit
                col="0"
                src={
                  users()[firstPopular().authorId]?.avatarUrl ||
                  author().avatarUrl
                }
                class="w-[28] h-[28] rounded-full"
                stretch="aspectFill"
              ...
              <label
                col="1"
                text={`${users()[firstPopular().authorId]?.name || author().name} • ${firstPopular().readMinutes}`}
