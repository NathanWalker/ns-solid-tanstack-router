      ...
      <gridlayout>
        <scrollview class="bg-[#edf1f9] dark:bg-[#070d1b]">
          <stacklayout class="px-5 pt-4 pb-8">
            <stacklayout
              class="bg-white dark:bg-[#0f182d] rounded-[24] p-4"
            ...
            >
              ...
              >
                <imagecacheit
                  ...
                  sharedTransitionTag={getPostAuthorAvatarTag(
                    data().post.authorId,
                  )}
                ...
                <stacklayout col="1" class="ml-3">
                  <label
                    ...
                    class="text-lg font-bold text-[#11131a] dark:text-[#f2f6ff]"
                  />
                  <label
